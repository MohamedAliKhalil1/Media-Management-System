...
public class InteractiveVideoEinfuegenListnerTest {
    ...
    @Test
    <T extends MediaContentUploadable> void INTERACTIVE_VIDEO_EINFUEGEN_TEST() {
        assertTrue(this.model.auflisten().size() == 0);
        this.controller.setCurrentMode(":c");
        this.controller.start("InteractiveVideo Mohamed Lifestyle,News 5000 3600 DWT 640 480 Abstimmung");
