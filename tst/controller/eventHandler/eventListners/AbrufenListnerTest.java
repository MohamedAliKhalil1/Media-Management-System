...
public class AbrufenListnerTest {
    ...
    @Test
    <T extends MediaContentUploadable> void ABRUFEN_TEST() {
        ...
        assertTrue( ((T)(this.zufaelligErzeuger.getMediaList().get(0))).getAC() == 0);
        this.controller.setCurrentMode(":u");
        this.controller.start("Addr1");
        assertTrue(((T)(this.zufaelligErzeuger.getMediaList().get(0))).getAC() == 1);
    }
}
